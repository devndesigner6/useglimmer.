...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tab value="Code">
    ...
    export default function InteractiveBook() {
      ...
      return (
        <div className="flex w-full h-full items-center justify-center bg-muted overflow-hidden">
          <div
            ref={bookRef}
          ...
          >
            ...
            >
              ...
              <div className="absolute top-0 left-0 bottom-0 w-2 md:w-3.5 z-30 flex flex-row justify-end">
                <div
                  className="w-0.5 h-full bg-background/25"
                />
                <div
                  className="w-0.5 h-full bg-foreground/15"
                />
              </div>
